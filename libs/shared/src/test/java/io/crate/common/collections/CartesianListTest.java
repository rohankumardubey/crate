...
public class CartesianListTest {
    ...
    public void testCartesianProduct_binary1x1() {
        assertThat(cartesianList(List.of(1), List.of(2))).containsExactly(
            List.of(1, 2));
    }

    @Test
    public void testCartesianProduct_binary1x2() {
        assertThat(cartesianList(List.of(1), List.of(2, 3))).containsExactly(
            List.of(1, 2), List.of(1, 3));
    }

    @Test
    public void testCartesianProduct_binary2x2() {
        assertThat(cartesianList(List.of(1, 2), List.of(3, 4)))
            .containsExactly(
                List.of(1, 3),
                List.of(1, 4),
                List.of(2, 3),
    ...
    public void testCartesianProduct_2x2x2() {
        assertThat(cartesianList(List.of(0, 1), List.of(0, 1), List.of(0, 1)))
            .containsExactly(
                List.of(0, 0, 0),
                List.of(0, 0, 1),
                List.of(0, 1, 0),
